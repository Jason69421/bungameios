...
gdjs.evtsExt__PhysicsCharacter3DKeyMapper__Platformer3DKeyboardMapper.Platformer3DKeyboardMapper = class Platformer3DKeyboardMapper extends gdjs.RuntimeBehavior {
  ...
  applyBehaviorOverriding(behaviorOverriding) {
    ...
    if (behaviorOverriding.CameraAngle !== undefined)
      this._behaviorData.CameraAngle = behaviorOverriding.CameraAngle;
    if (behaviorOverriding.LockedCameraAngle !== undefined)
      this._behaviorData.LockedCameraAngle = behaviorOverriding.LockedCameraAngle;
