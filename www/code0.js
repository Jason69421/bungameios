...
gdjs.GameSceneCode.GDFenceObjects1= [];
gdjs.GameSceneCode.GDFenceObjects2= [];
gdjs.GameSceneCode.GDFenceObjects3= [];
gdjs.GameSceneCode.GDFenceObjects4= [];
...
gdjs.GameSceneCode.GDThinPlatformObjects1= [];
gdjs.GameSceneCode.GDThinPlatformObjects2= [];
gdjs.GameSceneCode.GDThinPlatformObjects3= [];
gdjs.GameSceneCode.GDThinPlatformObjects4= [];
...
gdjs.GameSceneCode.GDBridgeSmallObjects1= [];
gdjs.GameSceneCode.GDBridgeSmallObjects2= [];
gdjs.GameSceneCode.GDBridgeSmallObjects3= [];
gdjs.GameSceneCode.GDBridgeSmallObjects4= [];
gdjs.GameSceneCode.GDBarrelObjects1= [];
gdjs.GameSceneCode.GDBarrelObjects2= [];
gdjs.GameSceneCode.GDBarrelObjects3= [];
gdjs.GameSceneCode.GDBarrelObjects4= [];
...
gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCrabObjects1Objects = Hashtable.newFrom({"Crab": gdjs.GameSceneCode.GDCrabObjects1});
gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCharacterObjects2Objects = Hashtable.newFrom({"Character": gdjs.GameSceneCode.GDCharacterObjects2});
gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCrabObjects2Objects = Hashtable.newFrom({"Crab": gdjs.GameSceneCode.GDCrabObjects2});
gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCrabObjects2Objects = Hashtable.newFrom({"Crab": gdjs.GameSceneCode.GDCrabObjects2});
gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCrabObjects2Objects = Hashtable.newFrom({"Crab": gdjs.GameSceneCode.GDCrabObjects2});
gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCharacterObjects1Objects = Hashtable.newFrom({"Character": gdjs.GameSceneCode.GDCharacterObjects1});
gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCrabObjects1Objects = Hashtable.newFrom({"Crab": gdjs.GameSceneCode.GDCrabObjects1});
...
gdjs.copyArray(gdjs.GameSceneCode.GDCharacterObjects1, gdjs.GameSceneCode.GDCharacterObjects2);

gdjs.copyArray(gdjs.GameSceneCode.GDCrabObjects1, gdjs.GameSceneCode.GDCrabObjects2);


let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.physics3d.isOnPlatform(gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCharacterObjects2Objects, "PhysicsCharacter3D", gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCrabObjects2Objects, "Physics3D", false);
if (isConditionTrue_0) {
/* Reuse gdjs.GameSceneCode.GDCrabObjects2 */
{gdjs.evtsExt__Crab__Flatten.func(runtimeScene, gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCrabObjects2Objects, "Animation", "PhysicsEllipseMovement3D", "ShakeModel3D", "Tween3D", null);
}
}
...
let isConditionTrue_0 = false;
{
/* Reuse gdjs.GameSceneCode.GDCharacterObjects1 */
/* Reuse gdjs.GameSceneCode.GDCrabObjects1 */
{gdjs.evtsExt__Player__PushBack.func(runtimeScene, gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCharacterObjects1Objects, "PhysicsCharacter3D", gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCrabObjects1Objects, 600, 400, null);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18702156);
}
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__Collision3D__AreWithinDistance.func(runtimeScene, gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCharacterObjects2Objects, gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCoinObjects2Objects, 50, false, null);
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("Crab"), gdjs.GameSceneCode.GDCrabObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.physics3d.haveObjectsStartedColliding(gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCharacterObjects1Objects, "Physics3D", gdjs.GameSceneCode.mapOfGDgdjs_9546GameSceneCode_9546GDCrabObjects1Objects, "Physics3D", false);
if (isConditionTrue_0) {
...
isConditionTrue_0 = gdjs.evtTools.runtimeScene.sceneJustBegins(runtimeScene);
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Barrel"), gdjs.GameSceneCode.GDBarrelObjects2);
gdjs.copyArray(runtimeScene.getObjects("Character"), gdjs.GameSceneCode.GDCharacterObjects2);
gdjs.copyArray(runtimeScene.getObjects("Cloud"), gdjs.GameSceneCode.GDCloudObjects2);
{for(var i = 0, len = gdjs.GameSceneCode.GDBarrelObjects2.length ;i < len;++i) {
    gdjs.GameSceneCode.GDBarrelObjects2[i].hide();
}
}
...
{
gdjs.copyArray(runtimeScene.getObjects("Character"), gdjs.GameSceneCode.GDCharacterObjects1);
{for(var i = 0, len = gdjs.GameSceneCode.GDCharacterObjects1.length ;i < len;++i) {
    gdjs.GameSceneCode.GDCharacterObjects1[i].getBehavior("ThirdPersonCamera").MoveCameraCloser(null);
}
}
}
...
gdjs.GameSceneCode.GDFenceObjects1.length = 0;
gdjs.GameSceneCode.GDFenceObjects2.length = 0;
gdjs.GameSceneCode.GDFenceObjects3.length = 0;
gdjs.GameSceneCode.GDFenceObjects4.length = 0;
...
gdjs.GameSceneCode.GDThinPlatformObjects1.length = 0;
gdjs.GameSceneCode.GDThinPlatformObjects2.length = 0;
gdjs.GameSceneCode.GDThinPlatformObjects3.length = 0;
gdjs.GameSceneCode.GDThinPlatformObjects4.length = 0;
...
gdjs.GameSceneCode.GDBridgeSmallObjects1.length = 0;
gdjs.GameSceneCode.GDBridgeSmallObjects2.length = 0;
gdjs.GameSceneCode.GDBridgeSmallObjects3.length = 0;
gdjs.GameSceneCode.GDBridgeSmallObjects4.length = 0;
gdjs.GameSceneCode.GDBarrelObjects1.length = 0;
gdjs.GameSceneCode.GDBarrelObjects2.length = 0;
gdjs.GameSceneCode.GDBarrelObjects3.length = 0;
gdjs.GameSceneCode.GDBarrelObjects4.length = 0;
